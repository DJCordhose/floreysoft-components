...
let DemoSection = class DemoSection extends LitElement {
    static get styles() {
        return [css `
            :host {
                display: block;
...
__decorate([
    property()
], DemoSection.prototype, "title", void 0);
__decorate([
    property()
], DemoSection.prototype, "npm", void 0);
__decorate([
    property()
], DemoSection.prototype, "github", void 0);
__decorate([
    property()
], DemoSection.prototype, "minified", void 0);
__decorate([
    property()
], DemoSection.prototype, "gzipped", void 0);
DemoSection = __decorate([
...
let Demo = class Demo extends LitElement {
    ...
    openDialog(id) {
        if (this.shadowRoot) {
            this.shadowRoot.getElementById(id).open = true;
        }
    }
};
Demo = __decorate([
